...
<div class="bx-catalog-element<?=$themeClass?>" id="<?=$itemIds['ID']?>" itemscope itemtype="http://schema.org/Product">
	...
	?>
	<div class="row">
        <span>Данный товар покупали: <?=$arResult['QUANTITY']?> раз(а)</span>
		<div class="col-md">
			...
			<div class="row">
				...
				<div class="<?=($showBlockWithOffersAndProps ? "col-lg-7" : "col-lg"); ?>">
					<div class="product-item-detail-pay-block">
                        ...
                        ?>
                        <div class="btn-block">
                            <button class="show_popup blue-btn" rel="popup1">Заказ в один клик</button>
                        </div>
                        ...
                        <div class="popup" id="popup1">
                            <div class="object">
                                <form id="form-callback" method="post">
                                    ...
                                    <p>Имя: </p>
                                    <p><input class="popup-input" type="text" name="name">
                                    <p>Телефон: </p>
                                    <p><input class="popup-input" type="text" name="phone"></p>
                                    <input type="hidden" name="product" value="<?="[".($arResult['ID'])."] ".$arResult['NAME'];?>">
                                    <input type="hidden" name="userId" value="<?=$id?>">
                                    <?=bitrix_sessid_post()?>
                                    <div class="submit-btn"><input type="submit" value="Отправить"></div>
                                </form>
                            </div>
                        </div>
					</div>
...
<script>
    ...
    <script>
        ...
        $('.overlay-popup').click(function () { // Обрабатываем клик по заднему фону
            $('.overlay-popup, .popup').hide(); // Скрываем затемнённый задний фон и основное всплывающее окно
        })
    </script>
<?php
