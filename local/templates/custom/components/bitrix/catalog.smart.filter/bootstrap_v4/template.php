                        ...
                        <div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> mb-2 smart-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
                            ...
                            <div class="smart-filter-block" data-role="bx_filter_block">
                                ...
                                switch ($arItem["DISPLAY_TYPE"])
                                {
                                    ...
                                    default:
                                        ?>
                                    <div class="smart-filter-input-group-checkbox-list parent-button-checkbox-containers">
                                            <?foreach($arItem["VALUES"] as $val => $ar):?>
                                                <div class="form-group form-check mb-1 button-checkbox-container">
                                                    <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="btn-razmer smart-filter-checkbox-text form-check-label" for="<? echo $ar["CONTROL_ID"] ?>">
                                                        <input
                                                                type="checkbox"
                                            ...
                                            <?foreach($arItem["VALUES"] as $val => $ar):?>
                                                <div class="form-group form-check mb-1">
                                                    ...
                                                    <input
                                                            ...
                                                            name="<? echo $ar["CONTROL_NAME"] ?>"
                                                            id="<? echo $ar["CONTROL_ID"] ?>"
                                                            class="checkbox-properties-filter"
                                                        <? echo $ar["CHECKED"]? 'checked="checked"': '' ?>
                                                        <? echo $ar["DISABLED"] ? 'disabled': '' ?>
                                                            onclick="smartFilter.click(this)"
                                                    />
